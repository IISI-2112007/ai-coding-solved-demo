...
require('TARGET_LABEL="security:approved"' in intake_workflow, "Issue workflow preserves the approved target label on rerun")
require('TARGET_LABEL="security:blocked"' in intake_workflow, "Issue workflow preserves the blocked target label on rerun")
require('for LABEL in "${OBSOLETE_LABELS[@]}"' in intake_workflow, "Issue workflow removes only obsolete security labels")
require('--add-label "$TARGET_LABEL"' in intake_workflow, "Issue workflow applies the computed target label")
